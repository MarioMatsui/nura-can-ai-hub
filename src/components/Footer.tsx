        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/termos-uso" className="text-muted-foreground hover:text-primary transition-smooth">
                  Termos de Uso
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/5511936206026" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-smooth">+55 (11) 93620-6026</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
