...
const features = [
  {
    ...
    description:
      "Suporte especializado para médicos com base em literatura científica atualizada",
  },
  {
    icon: Heart,
    title: "Assistência Veterinária com IA",
    description:
      "Orientações para tratamentos veterinários com cannabis medicinal",
  },
  {
    icon: Scale,
    title: "Assistência Jurídica com IA",
    description:
      "Informações legais e regulatórias sobre cannabis medicinal",
  },
  {
    icon: MessageSquare,
    title: "Chat Inteligente Especializado",
    description:
      "Conversas contextualizadas com IA treinada em cannabis medicinal",
  },
  {
    icon: Laptop,
    title: "Web App Fácil",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground">
            Tudo que você precisa para pesquisar e aplicar cannabis medicinal
