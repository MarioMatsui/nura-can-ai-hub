...
const SignUp = () => {
  ...
  const onSubmit = async (data: SignUpFormData) => {
    ...
    try {
      ...
      const { data: signupData, error: signupError } = await supabase.functions.invoke("validate-signup", {
        body: {
          email: data.email,
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Preencha seus dados para começar</p>
        </div>
